    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 p-10">
        <button 
          ...
          onClick={() => navigate('/entity-detail1')}
        >
          &lt; Back
        </button>
        <h2 className="text-2xl font-semibold mb-1">Entity Details</h2>
        <p className="text-sm text-gray-500 mb-6">
          Please complete your entity information.
        </p>
      ...
      <div className="w-72 min-h-screen bg-gradient-to-b from-[#0072ff] to-[#00c6ff] text-white flex flex-col justify-between p-8">
        ...
        <div className="mt-10 bg-white/10 p-4 rounded-lg backdrop-blur-sm">
          <h4 className="text-white font-semibold mb-2">Why Address Details matter?</h4>
          <p className="text-white/80 text-sm">
            Accurate address information ensures your business documents and communications reach you promptly and helps establish your business's legitimate presence.
          </p>
        </div>
